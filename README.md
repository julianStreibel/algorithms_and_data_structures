...
Running the following command loads the edges from [dh_stanford_edges.csv](Data/Graph/dh_stanford_edges.csv), builds a graph and runs dijksta with node 1 as the starting node.

```
gcc graph.c && ./a.out
```
The graph looks like this.
![dijkstra](statics/graph.png)
